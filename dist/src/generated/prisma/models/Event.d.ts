...
export type EventOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"id" | "title" | "description" | "startTime" | "endTime" | "isOnline" | "meetingLink" | "location" | "price" | "capacity", ExtArgs["result"]["event"]>;
