...
export type EnrollmentWhereInput = {
    ...
    completedLessonIds?: Prisma.StringNullableListFilter<"Enrollment">;
    progressPercentage?: Prisma.IntFilter<"Enrollment"> | number;
...
export type EnrollmentOrderByWithRelationInput = {
    ...
    completedLessonIds?: Prisma.SortOrder;
...
export type EnrollmentScalarWhereWithAggregatesInput = {
    ...
    completedLessonIds?: Prisma.StringNullableListFilter<"Enrollment">;
    progressPercentage?: Prisma.IntWithAggregatesFilter<"Enrollment"> | number;
};
export type EnrollmentCreateInput = {
    id?: string;
    enrolledAt?: Date | string;
    completedLessonIds?: Prisma.EnrollmentCreatecompletedLessonIdsInput | string[];
    progressPercentage?: number;
...
export type EnrollmentUpdateInput = {
    ...
    completedLessonIds?: Prisma.EnrollmentUpdatecompletedLessonIdsInput | string[];
...
export type EnrollmentCreatecompletedLessonIdsInput = {
    set: string[];
};
export type EnrollmentUpdatecompletedLessonIdsInput = {
    set?: string[];
    push?: string | string[];
};
...
export type EnrollmentOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"id" | "userId" | "courseId" | "enrolledAt" | "completedLessonIds" | "progressPercentage", ExtArgs["result"]["enrollment"]>;
...
export interface EnrollmentDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
     ...
     * })
     */
    findRaw(args?: Prisma.EnrollmentFindRawArgs): Prisma.PrismaPromise<Prisma.JsonObject>;
    /**
     ...
     * })
     */
    aggregateRaw(args?: Prisma.EnrollmentAggregateRawArgs): Prisma.PrismaPromise<Prisma.JsonObject>;
    /**
...
export interface EnrollmentFieldRefs {
    ...
    readonly completedLessonIds: Prisma.FieldRef<"Enrollment", 'String[]'>;
    readonly progressPercentage: Prisma.FieldRef<"Enrollment", 'Int'>;
}
/**
 ...
 * Enrollment findRaw
 */
export type EnrollmentFindRawArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = {
    /**
 ...
 */
export type EnrollmentAggregateRawArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = {
    /**
