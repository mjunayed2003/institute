...
export type EventRegistrationWhereInput = {
    ...
    attended?: Prisma.BoolFilter<"EventRegistration"> | boolean;
...
export type EventRegistrationScalarWhereWithAggregatesInput = {
    ...
    attended?: Prisma.BoolWithAggregatesFilter<"EventRegistration"> | boolean;
...
export type EventRegistrationOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"id" | "userId" | "eventId" | "attended" | "registeredAt", ExtArgs["result"]["eventRegistration"]>;
...
export interface EventRegistrationDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
    ...
    /**
     * Find zero or more EventRegistrations that matches the filter.
     * @param {EventRegistrationFindRawArgs} args - Select which filters you would like to apply.
     * @example
     * const eventRegistration = await prisma.eventRegistration.findRaw({
     *   filter: { age: { $gt: 25 } }
     * })
     */
    findRaw(args?: Prisma.EventRegistrationFindRawArgs): Prisma.PrismaPromise<Prisma.JsonObject>;
    /**
     * Perform aggregation operations on a EventRegistration.
     * @param {EventRegistrationAggregateRawArgs} args - Select which aggregations you would like to apply.
     * @example
     * const eventRegistration = await prisma.eventRegistration.aggregateRaw({
     *   pipeline: [
     ...
     * })
     */
    aggregateRaw(args?: Prisma.EventRegistrationAggregateRawArgs): Prisma.PrismaPromise<Prisma.JsonObject>;
    /**
...
/**
 * EventRegistration findRaw
 */
export type EventRegistrationFindRawArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = {
    /**
...
/**
 * EventRegistration aggregateRaw
 */
export type EventRegistrationAggregateRawArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = {
    /**
