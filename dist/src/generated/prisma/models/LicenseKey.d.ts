...
export type GetLicenseKeyAggregateType<T extends LicenseKeyAggregateArgs> = {
    [P in keyof T & keyof AggregateLicenseKey]: P extends '_count' | 'count' ? T[P] extends true ? number : Prisma.GetScalarType<T[P], AggregateLicenseKey[P]> : Prisma.GetScalarType<T[P], AggregateLicenseKey[P]>;
};
...
type GetLicenseKeyGroupByPayload<T extends LicenseKeyGroupByArgs> = Prisma.PrismaPromise<Array<Prisma.PickEnumerable<LicenseKeyGroupByOutputType, T['by']> & {
    [P in ((keyof T) & (keyof LicenseKeyGroupByOutputType))]: P extends '_count' ? T[P] extends boolean ? number : Prisma.GetScalarType<T[P], LicenseKeyGroupByOutputType[P]> : Prisma.GetScalarType<T[P], LicenseKeyGroupByOutputType[P]>;
}>>;
export type LicenseKeyWhereInput = {
    ...
    productId?: Prisma.StringFilter<"LicenseKey"> | string;
    userId?: Prisma.StringNullableFilter<"LicenseKey"> | string | null;
    isActivated?: Prisma.BoolFilter<"LicenseKey"> | boolean;
    activatedAt?: Prisma.DateTimeNullableFilter<"LicenseKey"> | Date | string | null;
...
export type LicenseKeyScalarWhereWithAggregatesInput = {
    ...
    productId?: Prisma.StringWithAggregatesFilter<"LicenseKey"> | string;
    userId?: Prisma.StringNullableWithAggregatesFilter<"LicenseKey"> | string | null;
    isActivated?: Prisma.BoolWithAggregatesFilter<"LicenseKey"> | boolean;
    activatedAt?: Prisma.DateTimeNullableWithAggregatesFilter<"LicenseKey"> | Date | string | null;
...
export type LicenseKeyCreateInput = {
    ...
    product: Prisma.DigitalProductCreateNestedOneWithoutLicenseKeysInput;
};
...
export type LicenseKeyUpdateInput = {
    ...
    product?: Prisma.DigitalProductUpdateOneRequiredWithoutLicenseKeysNestedInput;
};
...
export type LicenseKeyOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"id" | "key" | "productId" | "userId" | "isActivated" | "activatedAt" | "expiresAt", ExtArgs["result"]["licenseKey"]>;
...
export type LicenseKeyCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = Omit<LicenseKeyFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface LicenseKeyDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
    [K: symbol]: {
        types: Prisma.TypeMap<ExtArgs>['model']['LicenseKey'];
        meta: {
            name: 'LicenseKey';
        };
    };
    ...
    /**
     * Find zero or more LicenseKeys that matches the filter.
     * @param {LicenseKeyFindRawArgs} args - Select which filters you would like to apply.
     * @example
     * const licenseKey = await prisma.licenseKey.findRaw({
     *   filter: { age: { $gt: 25 } }
     * })
     */
    findRaw(args?: Prisma.LicenseKeyFindRawArgs): Prisma.PrismaPromise<Prisma.JsonObject>;
    /**
     * Perform aggregation operations on a LicenseKey.
     * @param {LicenseKeyAggregateRawArgs} args - Select which aggregations you would like to apply.
     * @example
     * const licenseKey = await prisma.licenseKey.aggregateRaw({
     *   pipeline: [
     ...
     * })
     */
    aggregateRaw(args?: Prisma.LicenseKeyAggregateRawArgs): Prisma.PrismaPromise<Prisma.JsonObject>;
    /**
     ...
     * })
    **/
    count<T extends LicenseKeyCountArgs>(args?: Prisma.Subset<T, LicenseKeyCountArgs>): Prisma.PrismaPromise<T extends runtime.Types.Utils.Record<'select', any> ? T['select'] extends true ? number : Prisma.GetScalarType<T['select'], LicenseKeyCountAggregateOutputType> : number>;
    /**
    ...
    **/
     ...
     *
    **/
    groupBy<T extends LicenseKeyGroupByArgs, HasSelectOrTake extends Prisma.Or<Prisma.Extends<'skip', Prisma.Keys<T>>, Prisma.Extends<'take', Prisma.Keys<T>>>, OrderByArg extends Prisma.True extends HasSelectOrTake ? {
        ...
        [P in OrderFields]: P extends ByFields ? never : `Error: Field "${P}" in "orderBy" needs to be provided in "by"`;
    }[OrderFields]>(args: Prisma.SubsetIntersection<T, LicenseKeyGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetLicenseKeyGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>;
    /**
...
export interface LicenseKeyFieldRefs {
    ...
    readonly productId: Prisma.FieldRef<"LicenseKey", 'String'>;
    readonly userId: Prisma.FieldRef<"LicenseKey", 'String'>;
    readonly isActivated: Prisma.FieldRef<"LicenseKey", 'Boolean'>;
    readonly activatedAt: Prisma.FieldRef<"LicenseKey", 'DateTime'>;
 ...
 * LicenseKey findRaw
 */
export type LicenseKeyFindRawArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = {
    /**
...
/**
 * LicenseKey aggregateRaw
 */
export type LicenseKeyAggregateRawArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = {
    /**
